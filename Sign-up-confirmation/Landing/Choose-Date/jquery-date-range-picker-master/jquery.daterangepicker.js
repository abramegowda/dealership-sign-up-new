...
(function(factory) {
  ...
  $.fn.dateRangePicker = function(opt) {
    ...
    function createDom() {
      ...
      var arrowPrev = "<img class='cal-arrow' src='choose-date-images/chevron-left.png'>";
      if (opt.customArrowPrevSymbol) arrowPrev = opt.customArrowPrevSymbol;

      var arrowNext = "<img class='cal-arrow' src='choose-date-images/chevron-right.png'>";
      ...
      html +=
        ...
        : "") +
        '<span class="reset"><img class="reset-icon" src="choose-date-images/reset.png">Reset</span>'+
        '</div>'+
        "               </th>" +
        "           </tr>" +
        '           <tr class="week-name">' +
